...
Route::group(['middleware' => 'admin'], function() {
	...
	Route::get('pos/cancel/{id}', 'POSController@cancelItem');
   	...
   	Route::get('orders/cancel-reservation/{id}', 'OrdersController@cancelReserve');
        Route::post('orders', 'OrdersController@searchorder')->name('searchorder');
   	// Sales
   	Route::get('current-sales', 'SalesController@history');
	Route::post('current-sales', 'SalesController@search')->name('search');
	...
	Route::get('population/population-stats-pullets', 'PopulationController@popStatsPullets');
	Route::get('population/dead-stats-pullets', 'PopulationController@deadStatsPullets');
