...
namespace BZpoultryfarm\Http\Controllers\Auth;

use BZpoultryfarm\Http\Controllers\Controller;
use BZpoultryfarm\Mail\ForgotPasswordEmail;
use BZpoultryfarm\Mail\ForgotPwUser;
