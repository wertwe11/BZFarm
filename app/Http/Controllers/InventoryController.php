...
class InventoryController extends Controller
{
    ...
    public function show()
    {
      ...
      $meds = Medicines::all();
      $supp = Supplies::all();
      $changes = InventoryChanges::orderby('id', 'desc')->paginate(10);
      ...
      $validator = Validator::make(Input::all(), $this->medsrules);
        if ($validator->fails()) {
            ...
            else
            {
              ...
              $inv->save();
//add new medicine changes
              $changes = new InventoryChanges;

              $changes->name = $request->name;
              $changes->quantity = $request->quantity;
              $changes->unit = $request->price;
...
// use quantities
 ...
 //used feeds   
                ...
                $changes->name = $request->name;
                $changes->quantity = $request->quantity;
                $changes->unit = $inv->price;
                $changes->unittype = $inv->unit;
                $changes->type = 'Feeds';
...
//update of pricing
    ...
    public function showEggs()
    {
      ...
      $changes = InventoryChanges::where('type', '=', 'Eggs')->orderby('id', 'desc')->paginate(10);
...
//deducted eggs
    ...
    public function showChickens()
    {
      ...
      $cull = Cull::all();
      $changes = InventoryChanges::where('type', '=', 'Chickens')->orderby('id', 'desc')->paginate(10);
    ...
    public function showPullets()
    {
      ...
      $changes = InventoryChanges::where('type', '=', 'Pullets')->orderby('id', 'desc')->paginate(10);
