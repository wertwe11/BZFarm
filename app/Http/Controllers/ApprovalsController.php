    ...
    public function approve($id)
    {
    	...
    	if ($action->action == 'Quantity Update')
    	{
    		if ($action->module == 'Inventory - Eggs')
    		{
                ...
                $changes->name = 'Egg Batch ' . $action->batch_id;
                $changes->type = 'Eggs';
    		...
    		if ($action->module == 'Inventory - Chickens')
    		{
                ...
                else
                {
                  ...
                  $dead->batch_id = $action->request_id;
                  $dead->quantity = $action->quantity;
                  $dead->total = $deadtotal->total + $action->quantity;
                  $dead->remarks = $action->remarks;
    		...
    		if ($action->module == 'Inventory - Pullets')
    		{
    		    $total = TotalPullets::find($action->request_id);
