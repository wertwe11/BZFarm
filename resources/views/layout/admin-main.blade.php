...
<head>
    ...
    <title>Poultry Farm Management System - @yield ('title')</title>
    ...
    <!-- Favicons -->
    <link href="{{ asset('img/bz1.png') }}" rel="icon">
...
<body>
    ...
    <!-- Other colors for "data color": purple | blue | green | orange | red
        ...
        You can also add an image using data-image tag -->
            ...
            <div class="logo" style="background-color: #394456;">
                <a href="/admin" class="simple-text" style="color:white">
                   BZ Poultry Farm <br> Management System
                </a>
                <hr class="br-2">
            </div>
            <div class="sidebar-wrapper" style="background-color: #394456;">
                <ul class="nav">
        ...
        <div class="main-panel">
           <nav class="navbar navbar-transparent navbar-absolute" style="background-color: #d7dde4">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand page-title" href="#" style="color:black"> @yield ('title') </a>
                    </div>
                    <div class="collapse navbar-collapse navbar-form" style="color: black">
            ...
            <footer class="footer">
                ...
                <div class="container-fluid">
                    ...
                    <p class="copyright pull-right" ><center>
                        ...
                        <a href="#"><strong>BZ Poultry Farm Management System</strong>. All Rights Reserved
                        </center>
                    </p>
                </div>
            </footer>
