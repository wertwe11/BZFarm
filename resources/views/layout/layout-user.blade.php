...
<head>
  <meta charset="utf-8">
  <title>Poultry Farm System</title>
  ...
  <header id="header" class="header-fixed">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="/" class=""><img src="img/logo.png" alt="" height="150px" style="margin-left: -100px;"></a></h1>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 text-lg-left text-center">
          <div class="copyright">
            &copy; Copyright <strong>Poultry Farm Management System</strong>. All Rights Reserved
          </div>
          <div class="credits">
            <!--
        ...
        <div class="col-lg-6">
          <nav class="footer-links text-lg-right text-center pt-2 pt-lg-0">
            <a href="https://bzfarm.tech/" class="scrollto">Home</a>
