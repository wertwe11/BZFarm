...
@section ('title', 'Inventory > Chickens')
...
<div class="container-fluid">
	<ul class="nav nav-pills nav-pills-info">
	  ...
	  <li class="active"><a href="/inventory/chickens">Chickens</a></li>
	...
	<div class="col-lg-8">
		<div class="card">
			  <div class="card-header" data-background-color="blue">
					<h4 class="title">Chickens</h4>
					<p class="category">Total number of chickens in each batch.</p>
			  </div>
					...
					<div class="collapse" id="update">
						...
						<div class="container-fluid">
							...
							<select class="choose-batch" id="remarks_update" style="width: 100%">
								<option></option>
								<option>Early Cull</option>
								<option>Death by Natural Causes</option>
								<option>Proplapse</option>
								<option>Killed by Another Chicken</option>
								<option>Flu</option>
								<option>Got Stolen</option>
								<option>Escaped from Cage</option>
								<option>Eaten by Dogs</option>
							</select><br><br>
	...
	<div class="col-lg-12">
		<div class="card">
			  <div class="card-header" data-background-color="blue">
					...
					<p class="category">Number of chickens in each batch entry.</p>
			  </div>
			  <div class="card-content table-responsive">
				<table class="table">
					<thead class="text-primary bold">
						...
						@else
							...
							<tr>
								...
								<td class="td-actions text-right">
									<button type="button" rel="tooltip" title="Edit" class="btn btn-warning btn-simple btn-xs edit-modal" data-id="{{ substr($item->batch_id, -1) }}" data-batchid="{{ $item->batch_id }}" data-quantity="{{ $item->quantity }}" data-type="chickens">
...
<div class="row">
	<div class="col-lg-6">
		<div class="card">
			  <div class="card-header" data-background-color="blue">
					...
					<p class="category">Quantity of dead chicken from each batch.</p>
			  </div>
			  <div class="card-content table-responsive">
				<table class="table">
					<thead class="text-primary bold">
	...
	<div class="col-lg-6">
		<div class="card">
			  <div class="card-header" data-background-color="blue">
					<h4 class="title">Cull</h4>
					<p class="category">Quantity of cull from each batch.</p>
			  </div>
			  <div class="card-content table-responsive">
				<table class="table">
					<thead class="text-primary bold">
					...
					<tbody>
						...
						@else
							...
							<tr>
								...
								<td>{{ $item->created_at }}</td>
								<td class="td-actions text-right">
									<button type="button" rel="tooltip" title="Edit" class="btn btn-warning btn-simple btn-xs edit-modal" data-id="{{ $item->batch_id }}" data-quantity="{{ $item->quantity }}" data-type="cull">
										<i class="material-icons">edit</i>
								  	</button>
								</td>
							</tr>
...
<!-- ADD MODAL -->
  <div class="modal fade" id="addInv" role="dialog" data-backdrop="static">
  ...
  <!-- EDIT MODAL -->
  <div class="modal fade" id="editInv" role="dialog"data-backdrop="static">
          ...
          <h4 class="modal-title">Edit Entry</h4>
	        ...
	        <div class="modal-body">
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<label>Quantity:</label>
						<input type="text" id="quantity_edit" class="form-control"placeholder="*required*" required>
            ...
            success: function(data) {
            	if ((data.errors)) {
            		...
            		$('.modal-footer').on('click', '.add-close', function () {
                        window.location.href = "/inventory/chickens";
                    });
