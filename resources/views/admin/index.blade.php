...
<div class="row">
    ...
    <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="card card-stats">
            ...
            <div class="card-content">
                ...
                <h3 class="title">{{ $medstotal }}
                <small>grams</small>
                </h3>
            </div>
            <div class="card-footer">
                <div class="stats">
                    <i class="material-icons">info_outline</i> Already updated.
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="card card-stats">
            ...
            <div class="card-content">
                <p class="category">Monthly Sales Revenue</p>
	                <h3 class="title">
            ...
            <div class="card-footer">
                <div class="stats">
                    <i class="material-icons">date_range</i> Already Updated.
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="card card-stats">
            ...
            <div class="card-content">
                <p class="category">Total Chickens</p>
                <h3 class="title">{{ $chickenstotal }}
    ...
    <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="card card-stats">
            ...
            <div class="card-content">
                <p class="category">Monthly Chicken Loss</p>
    ...
    <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="card card-stats">
            ...
            <div class="card-footer">
                <div class="stats">
                    <i class="material-icons">update</i> Within 7 Days.
                </div>
            </div>
        </div>
    </div>
