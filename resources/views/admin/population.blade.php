...
<div class="row">
	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header" data-background-color="blue">
	            <h4 class="title">Current Pullet Population</h4>
	            <!-- <p class="category">Here is a subtitle for this table</p> -->
	        </div>
	        <div class="card-content">
				<canvas id="popStatsPullets" width="400" height="150"></canvas>
                <br>
			</div>
		</div>
	</div>
...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header" data-background-color="blue">
                <h4 class="title">Pullets Mortality</h4>
                <!-- <p class="category">Here is a subtitle for this table</p> -->
            </div>
            <div class="card-content">
                <canvas id="popDeadPullets" width="400" height="150"></canvas>
                <br>
            </div>
        </div>
    </div>
...
$(document).ready(function(){
    ...
    $.ajax({
        url: "/population/population-stats-pullets",
        method: "GET",
        success: function(data) {
            console.log(data);
            var batch = [];
            ...
            var ctx = $("#popStatsPullets");

            var popStatsPullets = new Chart(ctx, {
                type: 'bar',
                data: chartdata,
                options: {
                    scales: {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            var ctx = $("#popDeadPullets");

            var popDeadPullets = new Chart(ctx, {
                type: 'line',
                data: chartdata,
                options: {
                    scales: {
