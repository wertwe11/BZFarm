	...
	<div class="col-lg-6 col-md-12">
		<div class="card">
			  ...
			  <div class="card-content table-responsive">
			       ...
			       <div class="col-lg-4">
	        		<select class="form-control" id="chooseFilter2">
	        			<option value="1">Remarks</option>
	        			<option value="2">Added By</option>
	        			<option value="3">Date Added</option>
	        		</select>
	        	</div>
	        	<div class="col-lg-6">
                    <input type="text" class="form-control" id="orderInput2" onkeyup="orderSearch2()" placeholder="Search...">
                </div> 
			      
				<table id="tblOrders2" class="table">
					<thead class="text-primary bold">
						<tr>
							<th>Quantity</th>
							<th>Remarks</th>
...
<!-- UPDATE MODAL -->
<div class="modal fade" id="updateInv" role="dialog"data-backdrop="static">
    <div class="modal-dialog">
...
<!-- EDIT1 MODAL -->
<div class="modal fade" id="editInv1" role="dialog"data-backdrop="static">
  ...
  <!-- EDIT2 MODAL -->
<div class="modal fade" id="editInv2" role="dialog"data-backdrop="static">
    <div class="modal-dialog modal-sm">
...
<script>
	...
	function orderSearch2() {
	  // Declare variables 
	  var input, filter, table, tr, td, i;
	  var choose = $('#chooseFilter2').val();
	  input = document.getElementById("orderInput2");
	  filter = input.value.toUpperCase();
	  table = document.getElementById("tblOrders2");
	  tr = table.getElementsByTagName("tr");
