				...
				<ul class="list-group">
					...
					<div class="collapse" id="updatePrice">
						...
						<div class="container-fluid">
							...
							<br>
							<center><button type="button" class="btn btn-sm btn-default cancel-this" data-toggle="collapse" data-target="#updatePrice" onClick="window.location.reload();">Cancel</button><button type="button" class="btn btn-sm btn-success update-this"onClick="window.location.reload();" >Update</button></center>
						</div>
					</div>
					...
					<div class="collapse" id="updateForSale">
						...
						<div class="container-fluid">
							...
							<br>
							<center><button type="button" class="btn btn-sm btn-default cancel-this" data-toggle="collapse" data-target="#updateForSale" onClick="window.location.reload();">Cancel</button><button type="button" class="btn btn-sm btn-success update-this1">Update</button></center>
						</div>
					</div>
					<li class="list-group-item action-tab" data-toggle="collapse" data-target="#updateReorder"><b>Update Item Reorder Level</b></li>
						...
						<div class="container-fluid">
							...
							<center><button type="button" class="btn btn-sm btn-default cancel-reorder" data-toggle="collapse" data-target="#updateReorder" onClick="window.location.reload();">Cancel</button><button type="button" class="btn btn-sm btn-success update-reorder">Update</button></center>
						</div>
					</div>
				</ul>
            </div>
...
<!-- ADD MODAL FEEDS/MEDS -->
  <div class="modal fade" id="addInv1" role="dialog" data-backdrop="static">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Add New Item</h4>
	        ...
	        <div class="modal-body">
				...
				<div class="row">
					...
					<div class="form-group col-lg-6">
						...
						<input type="text" class="form-control" id="name_add"placeholder="*required*" required autofocus>
						<p class="errorName text-center alert alert-danger hidden"></p>
					</div>

					<div class="form-group col-lg-6">
						<label for="price">Price:</label>
						<input type="text" class="form-control" id="price_add" placeholder="*required*"required>
				...
				<div class="row">
					...
					<div class="form-group col-lg-4">
						...
						<input type="text" id="quantity_add" class="form-control"placeholder="*required*" required>
					...
					<div class="form-group col-lg-4">
						...
						<input type="text" class="form-control" id="reorder_add"placeholder="*required*" required>
	        ...
	        <div class="modal-footer">
	        	<button type="button" class="btn btn-default add-close" data-dismiss="modal"onClick="window.location.reload();">Close</button>
				<button type="button" class="btn btn-info add-this1" data-dismiss="modal"onClick="window.location.reload();">Add</button>
	        </div>
  ...
  <!-- ADD MODAL SUPPLIES -->
  <div class="modal fade" id="addInv2" role="dialog" data-backdrop="static">
    <div class="modal-dialog">
          ...
          <h4 class="modal-title">Add New Item</h4>
	        ...
	        <div class="modal-body">
				...
				<div class="row">
					...
					<div class="form-group col-lg-6">
						<label for="name">Item Name:</label>
						<input type="text" class="form-control" id="name_add1"placeholder="*required*" required autofocus>
						<p class="errorName1 text-center alert alert-danger hidden"></p>
					</div>

					<div class="form-group col-lg-6">
						<label for="price">Price:</label>
						<input type="text" class="form-control" id="price_add1" placeholder="*required*"required>
				...
				<div class="row">
					...
					<div class="form-group col-lg-6">
						<label for="quantity">Quantity:</label>
						<input type="text" id="quantity_add1" class="form-control"placeholder="*required*" required>
						<p class="errorQuantity1 text-center alert alert-danger hidden"></p>
					</div>

					<div class="form-group col-lg-6">
						<label for="reorder">Reorder Level</label>
						<input type="text" class="form-control" id="reorder_add1"placeholder="*required*" required>
	        ...
	        <div class="modal-footer">
	        	<button type="button" class="btn btn-default add-close" data-dismiss="modal"onClick="window.location.reload();">Close</button>
				<button type="button" class="btn btn-info add-this2" data-dismiss="modal"onClick="window.location.reload();">Add</button>
	        </div>
  ...
  <!-- ADD MODAL PRODUCTS -->
  <div class="modal fade" id="addInv3" role="dialog" data-backdrop="static">
          ...
          <h4 class="modal-title">Add New Item</h4>
	        ...
	        <div class="modal-body">
				...
				<div class="row">
					...
					<div class="form-group col-lg-12">
						<label for="name">Item Name:</label>
						<input type="text" class="form-control" id="name_add2"placeholder="*required*" required autofocus>
				...
				<div class="row">
					...
					<div class="form-group col-lg-6">
						...
						<input type="text" class="form-control" id="retailprice"placeholder="*required*" required>
						<p class="errorRetail text-center alert alert-danger hidden"></p>
					</div>

					<div class="form-group col-lg-6">
						<label for="price">Wholesale Price:</label>
						<input type="text" class="form-control" id="wholesaleprice"placeholder="*required*" required>
				...
				<div class="row">
					...
					<div class="form-group col-lg-12">
						...
						<input type="text" id="quantity_add2" class="form-control"placeholder="*required*" required>
	        ...
	        <div class="modal-footer">
	        	<button type="button" class="btn btn-default add-close" data-dismiss="modal"onClick="window.location.reload();">Close</button>
				<button type="button" class="btn btn-info add-this3" data-dismiss="modal"onClick="window.location.reload();">Add</button>
	        </div>
  ...
  <!-- USE ITEM -->
  <div class="modal fade" id="useInv" role="dialog" data-backdrop="static">
    <div class="modal-dialog modal-sm">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Use <i class="useName no-italics"></i></h4>
	        ...
	        <div class="modal-body">
				...
				<div class="row">
					...
					<div class="form-group col-lg-12">
						...
						<input type="number" id="useInput" class="form-control"placeholder="*required*" min="0">
	        ...
	        <div class="modal-footer">
	        	<button type="button" class="btn btn-default use-close" data-dismiss="modal" onClick="window.location.reload();">Cancel</button>
  ...
  <!-- ADD QUANTITY -->
  <div class="modal fade" id="addQuant" role="dialog" data-backdrop="static">
    <div class="modal-dialog modal-sm">
          ...
          <h4 class="modal-title">Add Quantities for <i class="moreName no-italics"></i></h4>
	        ...
	        <div class="modal-body">
				...
				<div class="row">
					...
					<div class="form-group col-lg-12">
						Quantity:
						<input type="number" id="quantity_more" class="form-control" placeholder="*required*" min="0">
	        ...
	        <div class="modal-footer">
	        	...
	        	<button type="button" class="btn btn-info btn-md add-more" data-dismiss="modal" onClick="window.location.reload();">Add</button>
	        </div>
  ...
  <!-- VIEW MODAL -->
  <div class="modal fade" id="viewInv" role="dialog" data-backdrop="static">
