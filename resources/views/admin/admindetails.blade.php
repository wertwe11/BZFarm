							...
							<tbody>
								...
								<tr>
									...
									<td class="td-actions text-right">
		                            	...
		                            	@else
		                                <button type="button" rel="tooltip" title="Edit" class="btn btn-warning btn-simple btn-xs" onclick="window.location.href='edit/{{ $all->id }}'" >
		                                    <i class="material-icons">edit</i>
		                                </button>
...
<div id="disableThis" class="modal fade" role="dialog"data-backdrop="static">
...
<!-- Change Password -->
<div id="changePass" class="modal fade" role="dialog"data-backdrop="static">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
