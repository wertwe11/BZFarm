...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ URL::asset('img/bz1.png') }}" />
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <img src="{{ asset('img/bz1.png') }}" class="img-fluid img-logo" alt="DLG Poultry Farm">
            </div>
        </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <strong>BZ Poultry Farm Management System</strong>. All Rights Reserved
                </p>
            </div>
        </footer>
